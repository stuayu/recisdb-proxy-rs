...
const message = ref('')
const error = ref('')
const override = ref({ enabled_override: true, target_refresh_secs_override: null as number | null, min_dwell_secs_override: null as number | null, normal_dwell_secs_override: null as number | null, max_dwell_secs_override: null as number | null, allow_remote_override: null as boolean | null, prefer_local_override: null as boolean | null, preemptible_override: null as boolean | null })
...
async function load() {
  ...
  try {
    ...
    if (settings.value.enabled_override != null || settings.value.target_refresh_secs_override != null) {
      mode.value = 'override'
...
function resetRecommended() { Object.assign(override.value, { enabled_override: true, target_refresh_secs_override: null, min_dwell_secs_override: null, normal_dwell_secs_override: null, max_dwell_secs_override: null, allow_remote_override: null, prefer_local_override: null, preemptible_override: null }) }
